...
class RetirarScreen extends StatelessWidget {
  const RetirarScreen({super.key});
            ...
            children: [
              ...
              CustomButton(
                ...
                onPressed: () async {
                  ...
                  bool success = banco.retirar(monto);
                  ...
                  if (monto == 67) {
                    ...
                    banco.mostrarNotificacion(
                      mensaje:
                          "Retiraste \$${monto.toStringAsFixed(2)}",
                      tipo: "success",
                      icono: "withdraw",
                    );
                    ...
                    await mostrarLottie(
                      context,
                      'assets/animations/retirar.json',
                    );
                  }
                },
              ),
